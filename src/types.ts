export interface DiscworldBook {
	id: number;
	date: number;
	title: string;
	title_es: string;
	subseries: Subserie[] | string;
	subseries_es: Subserie[] | string;
	motives_es: string;
	notes: string;
	// read: boolean;
}

export interface DiscworldBookMain {
	id: number;
	date: number;
	title: string;
	title_es: string;
...
export interface DiscworldBookDetails {
	id: number;
	motives: string;
	notes: string;
}

export interface QTablePropsColumn {
	/**
